...
import { createTaskAsynAction, getPriorityApi, getTaskTypeApi, getUserApi, Priority, TaskType } from '../../Redux/Reducers/createTaskReducer';
    ...
    return (
        <form className='container' onSubmit={createTaskFrm.handleSubmit}>
            <div className='form-group'>
                <p>Project</p>
                <select name='projectId' className='form-control' onChange={createTaskFrm.handleChange}>
            ...
            <div className='form-group'>
                <p>Task Name</p>
                <input name='taskName' className='form-control' onChange={createTaskFrm.handleChange}/>
            ...
            <div className="form-group">
                <div className="row">
                    <div className="col-6">
                        <p>Priotity</p>
                        <select name="priotityId" className='form-control' onChange={createTaskFrm.handleChange}>
                    ...
                    <div className='col-6'>
                        <p>Task Type</p>
                        <select name='typeId' className='form-control'onChange={createTaskFrm.handleChange}>
                    ...
                    <div className="col-6">
                        ...
                        <div className="row">
                            <div className="col-12 mt-3">
                                ...
                                <input type='number' defaultValue={0} min={0} className='form-control' name='originalEstimate' onChange={createTaskFrm.handleChange}/>
                            </div>
                        </div>
                    </div>
                    <div className="col-6">
                        <p className='font-weight-bold'>Time Tracking</p>
                        <Slider defaultValue={30} value={Number(timeTracking.timeTrackingSpent)} tooltip={{ open: true }} max={Number(timeTracking.timeTrackingSpent) + Number(timeTracking.timeTrackingRemaining)}  />
                        <div className="row">
                            <div className="col-6 text-left font-weight-bold">{Number(timeTracking.timeTrackingSpent)} logged</div>
                            <div className="col-6 text-right font-weight-bold">{Number(timeTracking.timeTrackingRemaining)} remaining</div>
                        </div>
                        <div className="row " >
                            <div className="col-6">
                                <p>Time spent</p>
                                <input type='number' defaultValue={0} min={0} className='form-control' name='timeTrackingSpent' onChange={(e) => {
                                    ...
                                    createTaskFrm.setFieldValue('timeTrackingSpent',e.target.value)
                                }} />
                            </div>
                            <div className="col-6">
                                <p>Time remaining</p>
                                <input type='number' min={0} defaultValue={0} className='form-control' name='timeTrackingRemaining' onChange={(e) => {
                                    ...
                                    createTaskFrm.setFieldValue('timeTrackingRemaining',e.target.value)
                                }} />
                            </div>
                        </div>
                    </div>
